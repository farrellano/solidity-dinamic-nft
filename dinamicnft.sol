...
contract keeperFlower is ERC721, ERC721URIStorage, KeeperCompatibleInterface {
   ...
   // Metadata information for each stage of the NFT on IPFS.
    string[] IpfsUri = [
        "https://github.com/farrellano/json-nft/blob/main/json/1",
        "https://github.com/farrellano/json-nft/blob/main/json/2",
        "https://github.com/farrellano/json-nft/blob/main/json/3"
    ]; 

    uint256 lastTimeStamp;
    uint256 interval;

    constructor(uint _interval) ERC721("Flower EthSantiago", "stFL") {
        interval = _interval;
